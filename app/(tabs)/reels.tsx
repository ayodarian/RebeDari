...
const styles = StyleSheet.create({
  ...
  videoTouchOverlay: { ...StyleSheet.absoluteFillObject, zIndex: 10 },
  ...
  playPauseOverlay: { ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.15)' },
